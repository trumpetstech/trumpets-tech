...
include"inc/navbar.php";
    ...
    <!-- <div class="counter_area plus_padding">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-85 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <h4>We mix a potent combination of digital <br> marketing strategy with a generous splash of
                            <br> creative</h4>
                    </div>
                </div>
            </div>
